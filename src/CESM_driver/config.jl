...
#    :daily_record              => ["dTdt_ent", "dSdt_ent", "T_hadvs", "S_hadvs", "T_vadvs", "S_vadvs", "h_ML", "u", "v", "w", "T", "S", "b", "nswflx", "swflx"],
    :daily_record              => [],
    :monthly_record            => ["T", "S", "b", "T_ML", "S_ML", "dTdt_ent", "dSdt_ent", "h_ML", "nswflx", "swflx", "frwflx", "qflx", "fric_u", "taux", "tauy", "w", "u", "v", "T_hadvs", "T_vadvs", "S_hadvs", "S_vadvs", "Q_clim", "wT", "neb", "qflx2atm", "heat_cont", "frz_heat"],
