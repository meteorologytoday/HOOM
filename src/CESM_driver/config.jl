...
#    :daily_record              => ["dTdt_ent", "dSdt_ent", "T_hadvs", "S_hadvs", "T_vadvs", "S_vadvs", "h_ML", "u", "v", "w", "T", "S", "b", "nswflx", "swflx"],
    :daily_record              => [],
    :monthly_record            => ["T", "S", "b", "T_ML", "S_ML", "dTdt_ent", "dSdt_ent", "TSAS_clim", "SSAS_clim", "wT", "wS", "TFLUX_DIV_implied", "SFLUX_DIV_implied", "qflx2atm", "h_ML", "nswflx", "swflx", "frwflx", "qflx", "TEMP", "dTEMPdt", "SALT", "dSALTdt", "fric_u", "taux", "tauy", "TFLUX_DEN_z", "SFLUX_DEN_z", "div", "w_bnd", "u", "v", "TFLUX_CONV", "SFLUX_CONV"],
