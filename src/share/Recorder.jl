module RecordTool
    ...
    mutable struct Recorder
        ...
        function Recorder(data_table :: DataTable, varnames; other_varnames = nothing)
            ...
            for varname in varnames
                ...
                sobjs[varname] = StatObj(varname, string(du.id), data_table.grid_odims_str[du.grid])
            end
            ...
            if other_vars == nothing
                ...
                for (varname, varref, dimnames) in other_vars
                    du = data_table.data_units[varname]
                    sobjs[varname] = NonStatObj(varname, string(du.id), data_table.grid_odims_str[du.grid])
                end
            end
