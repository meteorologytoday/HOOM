...
for o in (
    [
        ...
        "gamma_mean", β_mean[:, :,25], ("lon", "lat"), Dict(
        "long_name"=>"Mean of entrainment efficiency",
        "units"=>"deg C",
        )
    ], [
        "gamma_std", β_std[:, :,25], ("lon", "lat"), Dict(
        "long_name"=>"Standard deviation of entrainment efficiency",
        "units"=>"deg C",
        )
    ],
)
